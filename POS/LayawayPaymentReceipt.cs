...
namespace POS
{
    public partial class LayawayPaymentReceipt : Form
    {
        #region Global Components

        string connectionString;

        public LayawayPaymentReceipt()
        {
            InitializeComponent();
            CenterToScreen();
        ...
        public string PaymentAmount
        {
            ...
            {
                paymentAmount = value;
                int amountPaid = Convert.ToInt32(paymentAmount);
                PaymentAmountLabel.Text = string.Format("{0:C}", amountPaid);
            }
        }
        ...
        public string AmountOwed
        {
            ...
            {
                amountOwed = value;
                int owedAmount = Convert.ToInt32(amountOwed);
                NewPrincipalLabel.Text = string.Format("{0:C}", owedAmount);
            }
        }
        ...
        public void SaveInvoiceToFile()
        {
            ...
            string transactionID = "LP" + transactionNumber;
