...
namespace POS
{
    public partial class DefaultLayawayReport : Form
    {
        #region Global Components

        string connectionString;

        public DefaultLayawayReport()
        {
            InitializeComponent();
            CenterToScreen();
        ...
        private void DefaultLayawayReport_Load(object sender, EventArgs e)
        {
            try
            {
                DisplayReport();
        ...
        public void DisplayReport()
        {
            ...
            reportData = reportDataManager.DefaultLayawayReport(date);
            reportViewer.SourceFile = reportPath + "LayawayDefaultReport.rdl";
